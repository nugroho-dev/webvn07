                ...
                <div class="row mb-4">
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <div class="class="col-lg-12 col-sm-12"">
                            <label for="title">Link File :</label>
                            <input type="text" class="form-control @error('link') is-invalid @enderror" id="link" name="link" required autofocus value="{{ old('link',$post->link) }}">
                            @error ('link')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
