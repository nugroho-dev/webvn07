  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                ...
                <a href="/home/download" class="btn btn-secondary d-inline-flex align-items-center me-2 "
            ...
            <div class="card-body"> 
                <div class="row mb-4">
                    <div class="col-lg-12 col-sm-12">
                        <form method="post" action="/home/download/{{ $post->slug }}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                        <!-- Form -->
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/home/download/checkSlug?title='+ title.value)
