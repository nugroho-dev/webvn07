    ...
    <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
            <div class="me-lg-3">
                ...
                <a href="/home/pengaduan/alur" class="btn btn-secondary d-inline-flex align-items-center me-2 " aria-haspopup="true" aria-expanded="false">
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card border-0 shadow components-section">
                <div class="card-body">
                    <div class="container">
                        <form method="post" action="/home/pengaduan/alur/{{ $post->slug }}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <!-- Form -->
                            <div class="row mb-4">
...
<script nonce={{ $cspNonce }}>
    ...
    title.addEventListener('change', function() {
        fetch('/home/perizinan/alur/checkSlug?title=' + title.value)
