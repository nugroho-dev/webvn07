              ...
              <div class="table-responsive mb-5">
                <table class="table table-centered table-nowrap mb-7 rounded">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border-0">{{ $items->firstItem() + $key }}. </td>
                            <td class="border-0">{{ $item->created_at }} </td>
                            <td class="border-0 ">{{ $item->name }}</td>
                            <td class="border-0 ">{{ $item->subject}}</td>
                            <td class="border-0 font-weight-bold">
                              ...
                              <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                  <a class="dropdown-item d-flex align-items-center" href="/dashboard/pengaduan/aduan/{{$item->id}}">
                                  ...
                                  <form method="post" action="/dashboard/pengaduan/laporan/">
                                      @method('delete')
                                      @csrf
