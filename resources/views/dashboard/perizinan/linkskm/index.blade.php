...
<main class="content">
  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                <a href="/dashboard/perizinan/linkskm/create" class="btn btn-secondary d-inline-flex align-items-center me-2"
            ...
            <table class="table table-centered  mb-5 rounded ">
                <thead class="thead-light text-capitalize">
                    <tr>
                        ...
                        <th class="border-0">link menu laporan skm</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ $link->link }}" class="text-primary fw-bold" target="_blank">{{ $link->link}}</a>
                        </td>
                            ...
                            <div class="col-2 col-sm-2 col-lg-2 col-xl-2 d-none d-lg-block d-xl-inline-flex align-items-center ms-lg-auto text-right justify-content-end px-md-0">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                        <a class="dropdown-item d-flex align-items-center" href="/dashboard/perizinan/linkskm/{{ $link->slug }}/edit">
                                        ...
                                        <form method="post" action="/dashboard/perizinan/linkskm/{{ $link->slug }}">
                                            @method('delete')
                                            @csrf
