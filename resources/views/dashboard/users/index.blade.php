      ...
      <div class="row row-deck row-cards">
                    ...
                    <div class="col-auto">
                      <span class="bg-primary text-white avatar"
                        ...
                        >
                          ...
                          <path d="M12 3v3m0 12v3" /></svg></span>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                      <span class="bg-green text-white avatar"
                        ...
                        >
                          ...
                          <path d="M6 5l14 1l-1 7h-13" /></svg></span>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                      <span class="bg-x text-white avatar"
                        ...
                        >
                          ...
                          <path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772" /></svg></span>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                      <span class="bg-facebook text-white avatar"
                        ...
                        <svg
                          ...
                          class="icon icon-1"
                        >
                          <path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3" /></svg ></span>
                    </div>
                    <div class="col">
        ...
        <div class="col-lg-6">
          <div class="row row-cards">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="progress progress-separated mb-3">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: 44%" nonce="{{ $cspNonce }}" aria-label="Regular"></div>
                    <div class="progress-bar bg-info" role="progressbar" style="width: 19%"  nonce="{{ $cspNonce }}" aria-label="System"></div>
                    <div class="progress-bar bg-success" role="progressbar" style="width: 9%" nonce="{{ $cspNonce }}" aria-label="Shared"></div>
                  </div>
                  <div class="row">
            ...
            <div class="col-12">
              <div class="card" style="height: 28rem" nonce="{{ $cspNonce }}">
                <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                  <div class="divide-y">
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/052f.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/002m.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/003m.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/000f.jpg)"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/001f.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/004m.jpg)"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/002f.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/003f.jpg)"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/063m.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                          <div class="text-truncate">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/006m.jpg)"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/004f.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/007m.jpg)"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/009m.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/010m.jpg)"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/005f.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-1" style="background-image: url(/tabler/static/avatars/006f.jpg)" nonce="{{ $cspNonce }}"> </span>
                        </div>
                        <div class="col">
            ...
            <div class="card-table table-responsive">
              <table class="table table-vcenter">
                ...
                <tbody>
                  <tr>
                    <td class="w-1">
                      <span class="avatar avatar-sm" style="background-image: url(/tabler/static/avatars/000m.jpg)" nonce="{{ $cspNonce }}"> </span>
                    </td>
                  ...
                  <tr>
                    <td class="w-1">
                      <span class="avatar avatar-sm" style="background-image: url(/tabler/static/avatars/052f.jpg)" nonce="{{ $cspNonce }}"> </span>
                    </td>
                    <td class="td-truncate">
                  ...
                  <tr>
                    <td class="w-1">
                      <span class="avatar avatar-sm" style="background-image: url(/tabler/static/avatars/002m.jpg)" nonce="{{ $cspNonce }}"> </span>
                    </td>
                    <td class="td-truncate">
                  ...
                  <tr>
                    <td class="w-1">
                      <span class="avatar avatar-sm" style="background-image: url(/tabler/static/avatars/003m.jpg)" nonce="{{ $cspNonce }}"> </span>
                    </td>
                    <td class="td-truncate">
                  ...
                  <tr>
                    <td class="w-1">
                      <span class="avatar avatar-sm" style="background-image: url(/tabler/static/avatars/000f.jpg)" nonce="{{ $cspNonce }}"> </span>
                    </td>
                    <td class="td-truncate">
                  ...
                  <td>
                    ...
                    <a href="#" class="ms-1" aria-label="Open website"
                      ...
                      >
                        ...
                        <path d="M13 18l-.397 .534a5.068 5.068 0 0 1 -7.127 0a4.972 4.972 0 0 1 0 -7.071l.524 -.463" /></svg ></a>
                  </td>
                ...
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 71%" nonce="{{ $cspNonce }}"></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 35.96%" nonce="{{ $cspNonce }}"></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 24.9%" nonce="{{ $cspNonce }}"></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 19.72%" nonce="{{ $cspNonce }}"></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 17.080000000000002%" nonce="{{ $cspNonce }}"> </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 13%" nonce="{{ $cspNonce }}"></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="w-50">
                    <div class="progress progress-xs">
                      <div class="progress-bar bg-primary" style="width: 8.4%" nonce="{{ $cspNonce }}"></div>
                    </div>
                  </td>
                </tr>
              </tbody>
            ...
            <div class="table-responsive">
              <table class="table table-selectable card-table table-vcenter">
                ...
                <tr>
                  ...
                  <td>
                    <span class="avatar avatar-sm" style="background-image: url(/tabler/static/avatars/052f.jpg)"> </span>
                  </td>
                </tr>
                <tr>
                  <td class="w-1 pe-0">
