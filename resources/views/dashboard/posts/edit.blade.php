    ...
    <div class="container-xl">
        <div class="row row-cards">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('title') is-invalid @enderror" id="titlenew" name="title" required autofocus value="{{ old('title', $post->title) }}">
          </div>
          <label class="form-label">Slug</label>
          <div class="mb-3">
            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slugnew" name="slug" required value="{{ old('slug',$post->slug) }}" readonly>
            @error ('slug')
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="mb-3">
                ...
                <textarea  id="hugerte-mytextarea" name="body" class="form-control @error('body') is-invalid @enderror" placeholder="Tulis Disini......." rows="3">{{ old('body',$post->body) }}</textarea>
                @error ('body')
                  <div class="invalid-feedback">
                    {{ $message }}   
                  </div> 
