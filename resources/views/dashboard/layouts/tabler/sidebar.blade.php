    ...
    <div class="container-fluid">
      ...
      <div class="navbar-nav flex-row d-lg-none">
        ...
        <div class="nav-item dropdown">
          <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu">
            <span class="avatar avatar-sm" style="background-image: url(./static/avatars/000m.jpg)" nonce="{{ $cspNonce }}"> </span>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        ...
        <ul class="navbar-nav pt-lg-3">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item" href="/home/posts">
                    Post
                  </a>
              </div>
            </div>
            ...
            <a class="nav-link" href="./form-elements.html">
              <span class="nav-link-icon d-md-none d-lg-inline-block"
                ...
                >
                  ...
                  <path d="M20 12v6a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h9" /></svg></span>
            ...
            >
              <span class="nav-link-icon d-md-none d-lg-inline-block"
                ...
                <svg
                  ...
                  class="icon icon-1"
                >
                  <path d="M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" /></svg></span>
              <span class="nav-link-title"> SP & SOP </span>
            </a>
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
            ...
            >
              <span class="nav-link-icon d-md-none d-lg-inline-block"
                ...
                >
                  ...
                  <path d="M14 15m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v1a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /></svg></span>
            ...
            <div class="dropdown-menu close">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  ...
                  <a class="dropdown-item active" href="./layout-fluid-vertical.html"> Fluid vertical </a>
          ...
          <li class="nav-item dropdown">
            ...
            >
              <span class="nav-link-icon d-md-none d-lg-inline-block"
                ...
                >
                  <path
                    d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"/></svg></span>
              <span class="nav-link-title"> Perizinan </span>
            </a>
            <div class="dropdown-menu">
            ...
            >
              <span class="nav-link-icon d-md-none d-lg-inline-block"
                ...
                >
                  ...
                  <path d="M7.5 8a2.5 2.5 0 0 1 0 -5a4.8 8 0 0 1 4.5 5a4.8 8 0 0 1 4.5 -5a2.5 2.5 0 0 1 0 5" /></svg></span>
              <span class="nav-link-title"> PPID </span>
            </a>
            <div class="dropdown-menu">
            ...
            >
              <span class="nav-link-icon d-md-none d-lg-inline-block"
                ...
                >
                  ...
                  <path d="M18.35 5.65l-3.35 3.35" /></svg></span>
          ...
          <li class="nav-item dropdown {{ Request::is('home/pengaturan*')?'active':'' }}">
            <a
              class="nav-link dropdown-toggle"
              href="#navbar-help"
              data-bs-toggle="dropdown"
            ...
            <div class="dropdown-menu {{ Request::is('home/pengaturan*')?'show':'' }} {{ Request::is('home/pengaturan/users*')?'active':'' }}">
              <a class="dropdown-item" href="/home/pengaturan/users" target="_self" rel="noopener">
