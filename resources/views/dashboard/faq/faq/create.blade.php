  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                ...
                <a href="/dashboard/list/faq?view={{ $slugcat }}" class="btn btn-secondary d-inline-flex align-items-center me-2 "
  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/list/faq" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="class="col-lg-12 col-sm-12"">
                            ...
                            <input type="text" class="form-control @error('question') is-invalid @enderror" id="title" name="question" required autofocus value="{{ old('question') }}">
                            @error ('question')
                        ...
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <textarea id="body" name="answer" class="form-control @error('answer') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('answer') }}</textarea>
                            @error ('answer')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/list/faq/checkSlug?title='+ title.value)
