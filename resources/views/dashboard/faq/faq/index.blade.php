...
<main class="content">
  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
            <a href="/dashboard/faq/" class="btn btn-primary d-inline-flex  me-2"
        ...
        <div class="me-lg-3">
                <a href="/dashboard/list/faq/create?view={{ $slugtitle }}" class="btn btn-secondary d-inline-flex align-items-center me-2"
                     aria-haspopup="true" aria-expanded="false">
...
<div class="accordion" id="accordionPricing">
    ...
    <div class="accordion-item">
      <h2 class="accordion-header" id="headingOne">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{ $post->slug }}" aria-expanded="true" aria-controls="collapseOne">
            {{ $items->firstItem() + $key }}. {{ $post->question }}
            
        </button>
           
      </h2>
      <div id="collapseOne{{ $post->slug }}" class="accordion-collapse collapse hide" aria-labelledby="headingOne" data-bs-parent="#accordionPricing">
        <div class="accordion-body">
            <div class="col-2 col-sm-2 col-lg-2 col-xl-2  d-lg-block d-xl-inline-flex ms-lg-auto  px-md-0">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                        <a class="dropdown-item d-flex align-items-center" href="/dashboard/list/faq/{{ $post->slug }}/edit?view={{ $slugtitle }}">
                        ...
                        <form method="post" action="/dashboard/list/faq/{{ $post->slug }}">
                            @method('delete')
                            @csrf
