  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/detail/spsop" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="accordion mt-3 " id="accordionPricing">
                                <div class="accordion-item">
                                  ...
                                  <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#accordionPricing">
                                    <div class="accordion-body">
                                      <textarea id="hukum" name="hukum" class="form-control @error('hukum') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('hukum') }}</textarea>
                                      @error ('hukum')
                                      <div class="invalid-feedback">
                                       {{ $message }}   
                                      </div> 
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#accordionPricing">
                                    <div class="accordion-body">
                                      <textarea id="persyaratan" name="persyaratan" class="form-control @error('persyaratan') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('persyaratan') }}</textarea>
                                      @error ('persyaratan')
                                      <div class="invalid-feedback">
                                       {{ $message }}   
                                      </div> 
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#accordionPricing">
                                    <div class="accordion-body">
                                      <textarea id="mekanisme" name="mekanisme" class="form-control @error('mekanisme') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('mekanisme') }}</textarea>
                                      @error ('mekanisme')
                                      <div class="invalid-feedback">
                                       {{ $message }}   
                                      </div> 
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="waktu" name="waktu" class="form-control @error('waktu') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('waktu') }}</textarea>
                                        @error ('waktu')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="biaya" name="biaya" class="form-control @error('biaya') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('biaya') }}</textarea>
                                        @error ('biaya')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="produk" name="produk" class="form-control @error('produk') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('produk') }}</textarea>
                                        @error ('produk')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="heading7" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="sarana" name="sarana" class="form-control @error('sarana') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('sarana') }}</textarea>
                                        @error ('sarana')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="kompetensi" name="kompetensi" class="form-control @error('kompetensi') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('kompetensi') }}</textarea>
                                        @error ('kompetensi')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse9" class="accordion-collapse collapse" aria-labelledby="heading9" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="pengawasan" name="pengawasan" class="form-control @error('pengawasan') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('pengawasan') }}</textarea>
                                      @error ('pengawasan')
                                      <div class="invalid-feedback">
                                       {{ $message }}   
                                      </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse10" class="accordion-collapse collapse" aria-labelledby="heading10" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="pengaduan" name="pengaduan" class="form-control @error('pengaduan') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('pengaduan') }}</textarea>
                                        @error ('pengaduan')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse11" class="accordion-collapse collapse" aria-labelledby="heading11" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="pelaksana" name="pelaksana" class="form-control @error('pelaksana') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('pelaksana') }}</textarea>
                                        @error ('pelaksana')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse12" class="accordion-collapse collapse" aria-labelledby="heading12" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="jaminan" name="jaminan" class="form-control @error('jaminan') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('jaminan') }}</textarea>
                                        @error ('jaminan')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse13" class="accordion-collapse collapse" aria-labelledby="heading13" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="keamanan" name="keamanan" class="form-control @error('keamanan') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('keamanan') }}</textarea>
                                        @error ('keamanan')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse14" class="accordion-collapse collapse" aria-labelledby="heading14" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="kinerja" name="kinerja" class="form-control @error('kinerja') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('kinerja') }}</textarea>
                                        @error ('kinerja')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse15" class="accordion-collapse collapse" aria-labelledby="heading15" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="formulir" name="formulir" class="form-control @error('formulir') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('formulir') }}</textarea>
                                        @error ('formulir')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapse16" class="accordion-collapse collapse" aria-labelledby="heading16" data-bs-parent="#accordionPricing">
                                      <div class="accordion-body">
                                        <textarea id="sop" name="sop" class="form-control @error('sop') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('sop') }}</textarea>
                                        @error ('sop')
                                        <div class="invalid-feedback">
                                         {{ $message }}   
                                        </div> 
