...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div>
        <div class="dropdown">
            <a href="/home/beranda/hero/create" class="btn btn-secondary d-inline-flex align-items-center me-2 dropdown-toggle">
                    ...
                    <div class="col-2 col-sm-2 col-lg-2 col-xl-2 d-none d-lg-block d-xl-inline-flex align-items-center ms-lg-auto text-right justify-content-end px-md-0">   
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                <a class="dropdown-item d-flex align-items-center" href="/home/beranda/hero/{{ $hero->slug }}/edit">
                                ...
                                <form method="post" action="/home/beranda/hero/{{ $hero->slug }}">
                                    @method('delete')
                                    @csrf
