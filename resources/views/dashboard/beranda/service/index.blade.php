...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div>
        <div class="dropdown">
            <a href="/dashboard/beranda/service/create" class="btn btn-secondary d-inline-flex align-items-center me-2 dropdown-toggle">
    ...
    <div class="col-lg-6 col-sm-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body">
                ...
                <h4>{!!$service->icon!!} <a href="#">{{ $service->title }}</a></h4>
                <div class="col-2 col-sm-2 col-lg-2 col-xl-2 d-none d-lg-block d-xl-inline-flex align-items-center ms-lg-auto text-right justify-content-end px-md-0">   
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                            <a class="dropdown-item d-flex align-items-center" href="/dashboard/beranda/service/{{ $service->slug }}/edit">
                            ...
                            <form method="post" action="/dashboard/beranda/service/{{ $service->slug }}">
                                @method('delete')
                                @csrf
