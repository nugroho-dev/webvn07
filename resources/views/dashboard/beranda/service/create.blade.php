  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/beranda/service" enctype="multipart/form-data">
                            @csrf
                        <!-- Form -->
                        <div class="row mb-4">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('description') }}</textarea>
                            @error ('description')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
...
<script nonce={{ $cspNonce }}>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/beranda/service/checkSlug?title='+ title.value)
