  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                ...
                <a href="/dashboard/beranda/link" class="btn btn-secondary d-inline-flex align-items-center me-2 "
  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/beranda/link" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <input type="text" id="link" name="link" class="form-control @error('link') is-invalid @enderror" required value={{ old('link') }} >
                            @error ('link')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/beranda/link/checkSlug?title='+ title.value)
