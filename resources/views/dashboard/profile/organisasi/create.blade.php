  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/profil/organisasi" enctype="multipart/form-data">
                            @csrf
                        <!-- Form -->
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <input type="text" class="form-control @error('tw') is-invalid @enderror" id="tw" name="tw"  value="{{ old('tw') }}">
                            @error ('tw')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
                        ...
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <input type="text" class="form-control @error('in') is-invalid @enderror" id="in" name="in"  value="{{ old('in') }}">
                            @error ('in')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/profil/organisasi/checkSlug?name='+ title.value)
