...
<main class="content">
  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                <a href="/dashboard/profil/organisasi/create" class="btn btn-secondary d-inline-flex align-items-center me-2"
            ...
            <table class="table table-centered  mb-5 rounded ">
                <thead class="thead-light text-capitalize">
                    <tr>
                        ...
                        <th class="border-0">Pangkat Golongan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('storage/'.$organization->image) }}" class="rounded rounded-4 img-fluid" alt="..." width="35">
                        </td>
                        <td>
                            <a href="/dashboard/profil/organisasi/{{ $organization->slug }}" class="text-primary fw-bold">{{ $organization->name }}</a>
                        </td>
                        <td>
                            {{ $organization->nip }}
                        </td>
                            ...
                            <div class="col-2 col-sm-2 col-lg-2 col-xl-2 d-none d-lg-block d-xl-inline-flex align-items-center ms-lg-auto text-right justify-content-end px-md-0">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                        <a class="dropdown-item d-flex align-items-center" href="/dashboard/profil/organisasi/{{ $organization->slug }}/edit">
                                        ...
                                        <form method="post" action="/dashboard/profil/organisasi/{{ $organization->slug }}">
                                            @method('delete')
                                            @csrf
