  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                ...
                <a href="/dashboard/profil/prestasi" class="btn btn-secondary d-inline-flex align-items-center me-2 "
  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/profil/prestasi/{{ $post->slug }}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                        <!-- Form -->
                        <div class="row mb-4">
                        ...
                        <div class="class="col-lg-12 col-sm-12"">
                            <label for="link">Link Berita Prestasi :</label>
                        ...
                        <div class="mb-4 col-lg-12 col-sm-12">
                          <label for="image" class="form-label">Gambar / Foto Prestasi</label>
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <label class="" for="body">Keterangan</label>
                            <textarea id="desc" name="desc" class="form-control @error('desc') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('desc', $post->desc) }}</textarea>
                            @error ('body')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/profil/prestasi/checkSlug?title='+ title.value)
