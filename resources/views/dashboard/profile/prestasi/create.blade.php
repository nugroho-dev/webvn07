  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/profil/prestasi" enctype="multipart/form-data">
                            @csrf
                        <!-- Form -->
                        <div class="row mb-4">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <textarea id="desc" name="desc" class="form-control @error('desc') is-invalid @enderror" placeholder="Tulis Disini......." required > {{ old('desc') }}</textarea>
                            @error ('body')
                            <div class="invalid-feedback">
                             {{ $message }}   
                            </div> 
