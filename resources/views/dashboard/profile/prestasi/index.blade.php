...
<main class="content">
  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
                <a href="/home/profil/prestasi/create" class="btn btn-secondary d-inline-flex align-items-center me-2"
            ...
            <table class="table table-centered  mb-5 rounded ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/home/profil/organisasi/{{ $performance->slug }}" class="text-primary fw-bold">{{ $performance->title }}</a>
                        </td>
                        <td>
                            {!! $performance->desc !!}
                        </td>
                            ...
                            <div class="col-2 col-sm-2 col-lg-2 col-xl-2 d-none d-lg-block d-xl-inline-flex align-items-center ms-lg-auto text-right justify-content-end px-md-0">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                        <a class="dropdown-item d-flex align-items-center" href="/home/profil/prestasi/{{ $performance->slug }}/edit">
                                        ...
                                        <form method="post" action="/home/profil/prestasi/{{ $performance->slug }}">
                                            @method('delete')
                                            @csrf
