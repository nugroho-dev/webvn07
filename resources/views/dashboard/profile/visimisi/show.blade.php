  ...
  <div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="col-auto d-flex justify-content-between ps-0 mb-4 mb-lg-0">
        <div class="me-lg-3">
            ...
            <a href="/home/profil/visimisi/{{ $post->slug }}/edit" class="btn btn-gray-800 d-inline-flex align-items-center me-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
            ...
            <form method="post" action="/home/profil/visimisi/{{ $post->slug }}"> 
                @method('put')
                 @csrf
            ...
            <form method="post" action="/home/profil/visimisi/{{ $post->slug }}" class="d-inline">
                @method('delete')
                @csrf
