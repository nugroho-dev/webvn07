  ...
  <div class="row">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow components-section">
            <div class="card-body"> 
                <div class="container">
                        <form method="post" action="/dashboard/profil/visimisi" enctype="multipart/form-data">
                            @csrf
                        <!-- Form -->
                        <div class="row mb-4">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <label class="" for="body">Artikel :</label>
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/profil/visimisi/checkSlug?title='+ title.value)
