        ...
        <div class="card-body">
          ...
          @if ($errors->any())
              <div class="alert alert-danger">
                  <strong>Double check your filling:</strong>
                  <ul class="mb-0 mt-1">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" name="email" value="{{ old('email', $request->email) }}" required/>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-flat">
              <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Confirm Password" autocomplete="off" required/>
            </div>
          </div>
