                            ...
                            <form action="/arep/mlebu/le" method="post" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="example@company.com" id="email" autofocus required value="{{ old('email') }}">
                                    @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><a href="./forgot-password.html" class="small text-right">Lupa kata sandi?</a></div>
                                    </div>
                                </div>
                                <div class="d-grid">
